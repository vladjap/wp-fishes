...
jQuery( function( $ ) {
    $(document).ready(function() {
        ...
        $('.fishmap-filter-fish-select').select2();
        addPagerToTables('#fishmap-fish-table, #relations-table-search-table', 10); // todo fix pagination + search

        // THIS WILL HIGHLIGHT SEARCH RESULTS
        var value = $('.fishmap-filter-fish-select').select2('data')[0].text;
        if (value && value !== 'Select fish') {
            var context = document.querySelector(".fishmap-logs-table-wrapper");
